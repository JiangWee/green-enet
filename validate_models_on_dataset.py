...
def main():
    ...
    full_model_path = './results/models/enet_green_ratio_full_officeGreenAndOriInput.pth'  # 完整模型路径
    encoder_model_path = './results/models/enet_green_ratio_encoder_officeGreenAndOriInput.pth'  # 编码器模型路径
